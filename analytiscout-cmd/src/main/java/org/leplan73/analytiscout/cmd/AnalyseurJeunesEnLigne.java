...
public class AnalyseurJeunesEnLigne extends CommonParamsIntranet {
	...
	public void run(CommandLine commandLine) throws CmdLineException
	{
		...
		try {
			...
			en.go(identifiant,motdepasse, new ResetableFileInputStream(new FileInputStream(batch)), new ResetableFileInputStream(new FileInputStream(modele)), structures, age, "tout_jeunes", recursif, psortie, anonymiser, garder, pargroupe, ddcs, options);
		} catch (Exception e) {
