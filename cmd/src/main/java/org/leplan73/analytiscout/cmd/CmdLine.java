...
@Command(name = "analytiscout", mixinStandardHelpOptions = true, versionProvider = CommonParamsG.class,
	subcommands = {Analyseur.class, AnalyseurJeunes.class, AnalyseurJeunesEnLigne.class, Extracteur.class, ExtracteurBatch.class, GenerateurVCard.class, GenerateurArchiveCsv.class, AnalyseurEnLigne.class, ExtracteurRegistreDePresence.class, AnalyseurRegistreDePresence.class, AnalyseurRegistreDePresenceCivile.class, AnalyseurCEC.class, AnalyseurCECEnLigne.class, StatsStructure.class})
