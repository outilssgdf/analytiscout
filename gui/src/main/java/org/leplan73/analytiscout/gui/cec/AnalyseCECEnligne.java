package org.leplan73.analytiscout.gui.cec;
...
public class AnalyseCECEnligne extends Dialogue implements LoggedDialog, GuiCommand {
	...
	public AnalyseCECEnligne() {
		...
		{
			JPanel panel = new JPanel();
			panel.setBorder(new TitledBorder(null, "Année d'analyse", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			GridBagConstraints gbc_panel = new GridBagConstraints();
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				txfAnnee.setEnabled(false);
				txfAnnee.setEditable(false);
				panel.add(txfAnnee, BorderLayout.NORTH);
