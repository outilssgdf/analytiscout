...
//			UIManager.setLookAndFeel(useopenjdk ? "javax.swing.plaf.windows.WindowsLookAndFeel" : "com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
	...
	private void initialize() {
		...
		frmOutils.setIconImage(Toolkit.getDefaultToolkit().getImage(OutilsSGDFAvance.class.getResource("/org/leplan73/outilssgdf/gui/icone.png")));
		...
		try {
			...
			JButton button_2 = new JButton("Exporter des données en batch");
			...
			JButton button_3 = new JButton("Analyser des données déjà extraites");
