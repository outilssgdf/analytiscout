...
public class AnalyseurJeunes extends Analyseur {
	...
	public AnalyseurJeunes() {
		super("Analyseur (Jeunes)",logger_,new File(Preferences.lit(Consts.REPERTOIRE_SORTIE, "données", false),"analyse_jeunes.xlsx"), new File("conf/batch_jeunes.txt"),new File("conf/modele_jeunes.xlsx"));
	}
}
