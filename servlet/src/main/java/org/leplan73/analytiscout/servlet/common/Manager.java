...
import org.leplan73.analytiscout.servlet.common.Database.Requete;
import org.leplan73.analytiscout.servlet.war.Logger;
import org.leplan73.analytiscout.servlet.war.Server;
...
public class Manager implements ServletContextListener {
    ...
    public static void initializeSwagger(int port)
	{
        ...
        beanConfig.setBasePath("/analytiscout/api");
